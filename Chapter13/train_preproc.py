...
if __name__ == "__main__":
    ...
    env = preproc.LocationWrapper(env_tw) if FLAGS_SEEN_ROOMS else env_tw
    r = env.reset()
    ...
    def validate(engine):
        ...
        if best_val_reward is None:
            ...
            save_prep_name = save_path / (f"best_val_{reward:.3f}_p.dat")
    ...
    def best_reward_updated(trainer: Engine):
        ...
        if reward > 0:
            save_prep_name = save_path / (f"best_train_{reward:.3f}_p.dat")
